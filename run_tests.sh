#!/bin/bash
# MemoGarden Client Test Runner
#
# Standardized test entrypoint for memogarden-client.
...
#   ./run_tests.sh tests/test_client.py::test_create_transaction
#   ./run_tests.sh --cov=mg_client --cov-report=term-missing
...
export PROJECT_NAME="memogarden-client"

# Python module name for coverage (e.g., "api", "system", "mg_client")
export MODULE_NAME="mg_client"
...
export VIRTUAL_ENV="/home/kureshii/memogarden/memogarden-client/.venv"
